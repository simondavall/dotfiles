return {
  ...
  config = function()
    ...
    local todo_keywords = " keywords=todo-sdv,fix-sdv,hack,remove-sdv,no-checkin"
    vim.keymap.set("n", "<leader>ftt", "<cmd>TodoTelescope" .. todo_keywords .. "<CR>", { desc = "Find sdv todos" })
    vim.keymap.set("n", "<leader>fta", "<cmd>TodoTelescope<CR>", { desc = "Find all todos" })
