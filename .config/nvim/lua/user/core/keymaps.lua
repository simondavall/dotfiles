...
keymap.set("n", "<leader>wk", "<cmd>resize +5<cr>", { desc = "Resize Up" })
keymap.set("n", "<leader>wj", "<cmd>resize -5<cr>", { desc = "Resize Down" })
keymap.set("n", "<leader>wh", "<cmd>vertical resize +5<cr>", { desc = "Resize Left" })
keymap.set("n", "<leader>wl", "<cmd>vertical resize -5<cr>", { desc = "Resize Right" })
